...
const Footer = ({ link, mailLink, phoneLink }) => {
  ...
  const instaLink = () => {
    let SocialLink = 'https://www.instagram.com/waterdrop.real/'
    window.open(SocialLink, "_blank");
  }

  const fbLink = () => {
    let SocialLink = 'https://www.facebook.com/waterdrop.real'
    window.open(SocialLink, "_blank");
  }

  const LinedInLink = () => {
    let SocialLink = 'https://www.linkedin.com/company/waterdrop01/'
    window.open(SocialLink, "_blank");
  }

  const ytLink = () => {
    let SocialLink = 'https://www.youtube.com/'
    window.open(SocialLink, "_blank");
  }
          ...
          <div className="footer-grid ">
            ...
            <div className="footer-contact mx-auto">
              ...
              <div className="footer-contact-data md:mt-auto md:mb-auto ">
                <div className="flex footer-have-a-question md:mb-8">
                ...
                <div className="flex footer-contact-us md:mt-8">
            ...
            <div className=" footer-social-links  mx-auto md:mt-auto md:mb-auto ">
              ...
              <div>
                <ul className="flex text-xl my-3  ">
                  <li className="md:m-1 sm:m-2">
                    <button className="facebook inline-flex items-center justify-center w-8 h-8  rounded-full text-sm" onClick={fbLink}>
                      <i className="fa fa-brands fa-facebook-f "></i>
                    </button>
                  </li>
                  <li className="md:m-1 sm:m-2">
                    <button className="youtube inline-flex items-center justify-center w-8 h-8   rounded-full text-sm" onClick={ytLink}>
                      <i className="fa-brands fa-youtube"></i>
                    </button>
                  </li>
                  <li className=" md:m-1 sm:m-2">
                    <button className="instagram inline-flex items-center justify-center w-8 h-8  rounded-full text-sm" onClick={instaLink}>
                      <i className="fa-brands fa-instagram"></i>
                    </button>
                  </li>
                  <li className="md:m-1 sm:m-2">
                    <button className="linkedin inline-flex items-center justify-center w-8 h-8  rounded-full text-sm" onClick={LinedInLink}>
